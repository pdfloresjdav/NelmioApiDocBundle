            ...
            ->children()
                ...
                ->arrayNode('swagger')
                    ...
                    ->children()
                        ...
                        ->scalarNode('swagger_version')->defaultValue('2.0')->end()
                        ->scalarNode('api_version')->defaultValue('1.0.0')->end()
                        ->arrayNode('info')
                            ->addDefaultsIfNotSet()
                                ->children()
                                    ->scalarNode('title')->defaultValue('EOS API')->end()
                                    ->scalarNode('description')->defaultValue('This is EOS API for retrieving contents')->end()
